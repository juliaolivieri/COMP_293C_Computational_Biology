...
parser.add_argument("--in_file","-i",help="fasta file to create reads from",default="c_elegans_chr1.fa")
...
for i in range(args.num_reads):
  out.write(">{}_readlen_{}_qual_{}\n".format(i,args.read_len, args.qual))
